...
{
public:
	SOCKETINFO *user_socket_info;

	SOCKETINFO get_client_context()
	{
		return *user_socket_info;
	};
...
public:
	...
	void notify(char* msg)
	{
		...
		cout << "==========================" << endl;
		cout << "incoming notified data \n";
		cout << "Id = " << sUser_info.id << endl;
		cout << "temp = " << sUser_info.pos_x << endl;
		cout << "temp = " << sUser_info.pos_y << endl;
		cout << "==========================" << endl;
	}
	...
	void notify(BYTE* msg, size_t size)
	{
		...
		//cout << "incoming notified data(byte)..." << endl;
		} 
		catch (DWORD dwError)
		{
